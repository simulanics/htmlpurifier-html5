    ...
    extends HTMLPurifier_HTMLModule_HTML5_Forms_InputTest
{
    public function dataProvider()
    {
        return array(
            ...
            // This is where Nu Validator (https://validator.w3.org/nu) doesn't conform
            // to WHATWG spec, because it requires a non-empty value attribute to be present,
            // whereas according to the spec value attribute is optional, and an empty string
            // is perfectly valid.
